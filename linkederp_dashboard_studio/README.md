...
- AI leads generated
- Worked/contacted leads and contact rate
- Meetings set and meeting rate
- Not-yet-called backlog
- Not suitable and unreachable rates
- Follow-up needed
- Open AI pipeline
- Lead funnel
- Call outcomes
- Leads generated by day
- Campaign, stage, and salesperson performance

The AI dashboard uses CRM leads where `Source` matches `AI Generated`. Make sure AI-created leads are saved with that source value.
